    ...
    <div id="page">
      ...
      <div id="Message-Container">
        <div id="message">
          ...
          {/* //NOTE - Replacing code above with code below */}
          <button id="okBtn" onClick={() => toggleVisablity('Message-Container')}>Cool!</button>
        </div>
      </div>
      ...
      <div id="menu">
        ...
        {/* //NOTE - Replacing code above with code below */}
        <button id="startMazeBtn" onClick={makeMaze}>Start</button>
      </div>
